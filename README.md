...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cpu_features-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cpu_features-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add cpu_features
# for installing globally
pixi global install cpu_features
```
...
It is possible to list all of the versions of `cpu_features` available on your platform:
...
```
pixi search cpu_features --channel conda-forge
```
